...
unsigned int nStakeMinAge = 3 * 24 * 60 * 60; // 3 days
unsigned int nStakeMaxAge = 180 * 24 * 60 * 60;           //180
...
const string strMessageMagic = "MillenniumCoin Signed Message:\n";
...
static const int64_t nTargetTimespan = 5 * 30;  // 2.5 mins
//
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MillenniumCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "26/5";
        CTransaction txNew;
        txNew.nTime = 1401048356;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x763342d04d77e22b40b1fa44e3b8360eafd72c3104d059582abf4d09fff9248f"));
        block.print();
